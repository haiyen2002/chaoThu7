...
export const comingEvent = [
    {
        ...
        position:'Trà Cang, Nam Trà My, Quảng Nam',
        description: ' Suất quà trên được dự trù theo kinh phí 19 triệu sau gây quỹ. Trong trường hợp kinh phí tăng hoặc giảm CLB sẽ kết toán và phân chia lại phần quà tương ứng.'
    },
    {
        ...
        position: 'Trà Nam, Nam Trà My, Quảng Nam',
        description: 'Trao tặng 80 xuất quà cho tương ứng 80 hộ dân, mỗi xuất trị giá 275.000 đ (bao gồm vật dụng lao động: cuốc, rựa, bạt, ..và một số gia vị cần thiết).'
    },
    {
        ...
        position: 'Cổng trường ĐH Sư Phạm- TP HN.',
        description: 'Mỗi bông hoa bạn ủng hộ CLB với ý nghĩa như là lời yêu thương gửi đến người bạn yêu quýlà tình yêu thương được gửi đến các hoàn cảnh khó khăn.'
    }
]
...
export const currentEvent = [
    {
        ...
        description: 'Đây là hoạt động thường xuyên do CLB Cháo Thứ 7 cùng với các mạnh thường quân tổ chức định kỳ.'
    }
]
